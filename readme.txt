=== Twilio Easy Call ===
Contributors: zonnix
Tags: twilio, click2call, call, voice call, voice, click to call, click 2 call
...
Twilio makes it easy to implement and integrate click-to-call directly into your web application.
...
><strong>This features are available only Premium version</strong> 
 Check our <a href="http://codecanyon.net/item/twilio-easy-call-pro/13892822" target="_blank" >Twilio Easy Call PRO</a> version.
...
1. Download "Twilio Easy Call" plugin and upload it to the /wp-content/plugins/ directory.
2. Activate "Twilio Easy Call" plugin through the Plugins menu.
3. Go to "Twilio Easy Call" on the admin menu.
4. Go to 'https://www.twilio.com/user/account/settings' and get your API Credentials: AccountSID, AuthToken and Twilio number.
5. Add "Twilio Easy Call" shortcode on any page on your website where you want a click to call form and button to be displayed.
